...
const wasmFilePath = '/helloworld-main.wasm'  // Path to our WASI module
const echoStr      = 'Thomas'    // Text string to echo

const params = new URLSearchParams(window.location.search)

var inputName = echoStr;
...
let wasi = new WASI({
  ...
  // we want to run.
  args: [wasmFilePath, inputName],

  // Environment variables that are accesible to the WASI module
  env: {
    'HELLOWORLD_ENV': 'in_browser_ENV'
  },
...
const startWasiTask =
  async pathToWasmFile => {
    ...
    document.write(`${stdout}`) // Write stdout data to the DOM
  }
